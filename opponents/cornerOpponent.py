...
#
# Sound contact play (capture, defend, attack, connect) with a soft
# lean toward the top-left corner.
# Its distinct trait is the corner lean.
...
W_BIAS = 3.0   # soft lean toward the top-left corner (its identity)
...
class CornerOpponent:
    ...
    def __init__(self, board_size=9):
        ...
        # precompute a bias map that peaks at the top-left corner and
        # falls off toward the bottom-right — this is the opponent's identity
        n = board_size
    ...
    # (tactics + corner bias) and return the best, breaking ties at random
