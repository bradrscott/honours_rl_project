...
# Phase 2: Feudal abrupt-shift & recovery — UCT CPU (ada), 13x13 
# 9 conditions = 3 magnitudes x 3 frequencies (array 0-8)
# Resumes the 13x13 Phase-1 feudal checkpoint of opponent A and applies a shift schedule.
# sbatch run_phase2_feudal_13x13_uct.sh
