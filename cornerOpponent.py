# ── Corner-Focused Opponent (blundering + corner lean) ────────
#
# Sound-ish contact play (capture / defend / attack / connect) with a soft
# lean toward the top-left corner. Deliberately does NOT use self-atari / eye
# / territory avoidance, so it BLUNDERS — which keeps it beatable by a trained
# PPO. Its distinct trait is the corner lean. Strict eps=0.
#
